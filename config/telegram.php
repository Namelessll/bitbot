...
return [
    ...
    */
    'bots'                         => [
        'mybot' => [
            'username'            => 'bitcoinManinerr_bot',
            'token'               => env('TELEGRAM_BOT_TOKEN', '944214855:AAF_Cd4MwxoFiCd0_i8Gkl_gcCmRcWs8cq8'),
            //'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'https://2442b883.ngrok.io'),
            'commands'            => [

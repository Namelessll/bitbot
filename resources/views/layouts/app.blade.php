                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs" style="border-bottom: none;">
                            <li class="nav-item">
                                <a class="nav-link @if(\Request::route()->getName() == "getHomepage") active @endif" href="{{route('getHomepage')}}">Настройки сервера</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#">Вопросы пользователей</a>
                            </li>
                        </ul>
                    </div>
                </div>
